...
echo "\n# copying 1.2G of installer files to the USB drive, please wait"
...
$rsync -P $InstallESD_mount_point/BaseSystem.* $target_drive_mount_point/
sync
